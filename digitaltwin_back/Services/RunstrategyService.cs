...
namespace auth.Services
{
    ...
    public class RunstrategyService
    {
        ...
        public async Task<List<Runstrategy>> upgradeData(R1Dto r1Dto, R2Dto r2Dto)
        {
            ...
            args[1] = r1Dto.S1time2;
            args[2] = r2Dto.S1time1;
            args[3] = r2Dto.S1time2;
            args[4] = r1Dto.S2time1;
            args[5] = r1Dto.S2time2;
            args[6] = r2Dto.S2time1;
            args[7] = r2Dto.S2time2;
            args[8] = r1Dto.S3time1;
            args[9] = r1Dto.S3time2;
            args[10] = r2Dto.S3time1;
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                _database.NewOnandoffs.Update(onandoff); //加入数据库
            }
            ...
            for (int i = 0; i < nums3.Length; i++)
            {
                ...
                _database.NewConsumptions.Update(consumption); //加入数据库
            }
