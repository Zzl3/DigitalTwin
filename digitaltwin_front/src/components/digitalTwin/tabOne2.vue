<template>
    <div id="container" style="display: flex; flex-direction: row">
      <numberCard2></numberCard2>
      <numberCard3></numberCard3>
  ...
  import numberCard2 from "@/components/digitalTwin/numberCard2.vue";
  import numberCard3 from "@/components/digitalTwin/numberCard3.vue";
  export default {
    components: {
            numberCard2,
            numberCard3,
